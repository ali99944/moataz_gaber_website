...
export default function Services() {
  ...
  const services = [
    {
      icon: <FaKitchenSet className="text-4xl text-[#FF0000]" />,
      title: 'تصميم المطابخ',
    ...
    {
      icon: <FaPaintRoller className="text-4xl text-[#FF0000]" />,
    ...
    {
      icon: <FaRuler className="text-4xl text-[#FF0000]" />,
    ...
    {
      icon: <FaWrench className="text-4xl text-[#FF0000]" />,
      title: 'صيانة وتركيب',
