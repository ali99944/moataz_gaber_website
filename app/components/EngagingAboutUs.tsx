    ...
    <section ref={ref} className="py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">نحن شركة معتز جابر للمطابخ والديكور، نجمع بين الفن والوظيفة لخلق مساحات استثنائية تعكس شخصيتك وتلبي احتياجاتك</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            ...
            />
            <div className="absolute -bottom-6 -right-6 w-full h-full bg-[#FF0000] rounded-lg -z-10"></div>
          </motion.div>
        ...
        >
          <a href="#contact" className="inline-block bg-[#FF0000] text-white font-bold py-3 px-8 rounded-lg text-lg hover:bg-opacity-90 transition duration-300 shadow-md">
