          ...
          <div className="bg-white shadow-md rounded-lg p-8 order-2 lg:order-1">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-[#FF0000] text-white font-bold py-3 px-6 rounded-lg transition duration-300"
                >
                  إرسال الرسالة
                </button>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-4">
                    <FaPhone className="text-2xl mt-1 text-[#FF0000]" />
                    <div>
                  ...
                  <li className="flex items-start gap-4">
                    <FaEnvelope className="text-2xl mt-1 text-[#FF0000]" />
                    <div>
                  ...
                  <li className="flex items-start gap-4">
                    <FaMapMarkerAlt className="text-2xl mt-1 text-[#FF0000]" />
                    <div>
